    ...
    public:
        ...
        static void Reflect(AZ::ReflectContext* context)
        {
            ...
            if (serializeContext)
            {
                ...
                if (scriptContext)
                {
                    scriptContext->Class<SphereShapeConfiguration, void(float), AZ::ScriptContext::SP_RAW_SCRIPT_OWN>("SphereShapeConfiguration")
                        ->Property("radius", &SphereShapeConfiguration::m_radius, &SphereShapeConfiguration::m_radius);
                }
            }
        }
