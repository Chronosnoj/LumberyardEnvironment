    ...
    namespace SceneAPI
    {
        namespace Containers
        {
            namespace Views
            {
                ...
                template<typename Iterator>
                auto SceneGraphUpwardsIterator<Iterator>::operator*()->reference
                {
                    return *m_iterator;
                }

                template<typename Iterator>
                auto SceneGraphUpwardsIterator<Iterator>::GetPointer(AZStd::true_type)->pointer
                {
                    return m_iterator;
                }

                template<typename Iterator>
                auto SceneGraphUpwardsIterator<Iterator>::GetPointer(AZStd::false_type)->pointer
                {
                    return m_iterator.operator->();
                }

                template<typename Iterator>
                auto SceneGraphUpwardsIterator<Iterator>::operator->()->pointer
                {
