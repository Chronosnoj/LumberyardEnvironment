    ...
    namespace SceneAPI
    {
        ...
        namespace Events
        {
            ...
            public:
                ...
                SCENE_CORE_API virtual ProcessingResult PrepareForAssetLoading(Containers::Scene& scene);
                ...
                SCENE_CORE_API virtual void FinalizeAssetLoading(Containers::Scene& scene);
