    ...
    public:
        ...
        static void Reflect(AZ::ReflectContext* context)
        {
            ...
            if (serializeContext)
            {
                ...
                if (scriptContext)
                {
                    scriptContext->Class<CapsuleShapeConfiguration, void(AZ::ScriptDataContext&), AZ::ScriptContext::SP_RAW_SCRIPT_OWN>("CapsuleShapeConfiguration")
                        ->Property("height", &CapsuleShapeConfiguration::m_height, &CapsuleShapeConfiguration::m_height)
                        ->Property("radius", &CapsuleShapeConfiguration::m_radius, &CapsuleShapeConfiguration::m_radius);
                }
            }
        }
