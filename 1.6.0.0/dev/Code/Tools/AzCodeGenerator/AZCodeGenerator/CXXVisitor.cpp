...
namespace CodeGenerator
{
    ...
    {
        if (!ShouldVisitRecord(decl))
        {
            // Returning true means we want the visitation to proceed, false will stop the traversal of the AST.
            return true;
        }
    ...
    bool CXXVisitor::ShouldVisitRecord(clang::CXXRecordDecl* decl)
    {
