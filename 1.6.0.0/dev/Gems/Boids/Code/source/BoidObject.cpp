...
IMaterial* CBoidObject::GetMaterialForPhysicalization() const
{
    ...
    IMaterial* pMat = m_object ? m_object->GetIMaterial() : nullptr;
...
void CBoidObject::Physicalize(SBoidContext& bc)
{
    ...
    IMaterial* pMat = GetMaterialForPhysicalization();
