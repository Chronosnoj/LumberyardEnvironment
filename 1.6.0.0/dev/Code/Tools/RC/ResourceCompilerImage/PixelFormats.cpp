...
void PixelFormatsInitializer::InitPixelFormats()
{
    ...
    InitPixelFormat(ePixelFormat_CTX1,         PixelFormatInfo(4, 2, false, "0",   4, 4,  4, 4,  64, false, D3DFMT_CTX1,     DXGI_FORMAT_UNKNOWN,        eSampleType_Compressed, "CTX1",         "CTX1 4 bpp compressed normal maps for Xbox 360", true, false, eTF_CTX1));
