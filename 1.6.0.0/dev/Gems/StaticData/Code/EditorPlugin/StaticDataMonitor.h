...
namespace CloudCanvas
{
    namespace StaticData
    {
        ...
        class StaticDataMonitor : public QObject, public IStaticDataMonitor
        {
        ...
        public:
            ...
            void SetManager(CloudCanvas::StaticData::IStaticDataManager* newManager);
        ...
        private:
            ...
            CloudCanvas::StaticData::IStaticDataManager* m_manager{ nullptr };
