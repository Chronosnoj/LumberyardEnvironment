...
namespace LmbrCentral
{
    ...
    class AudioProxyComponent
        ...
        , public AudioProxyComponentRequestsBus::Handler
    {
    public:
        /*!
         * AZ::Component
        ...
        /*!
        * AudioProxyComponentRequestsBus::Handler
        * Required Interface
        */
        bool ExecuteTrigger(
    ...
    protected:
        ...
        {
            provided.push_back(AZ_CRC("AudioProxyService"));
        }
        ...
        {
            incompatible.push_back(AZ_CRC("AudioProxyService"));
        }
