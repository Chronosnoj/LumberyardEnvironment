    ...
    public:
        ...
        static void Reflect(AZ::ReflectContext* context)
        {
            ...
            if (serializeContext)
            {
                ...
                if (scriptContext)
                {
                    scriptContext->Class<CylinderShapeConfiguration, void(AZ::ScriptDataContext&), AZ::ScriptContext::SP_RAW_SCRIPT_OWN>("CylinderShapeConfiguration")
                        ->Property("height", &CylinderShapeConfiguration::m_height, &CylinderShapeConfiguration::m_height)
                        ->Property("radius", &CylinderShapeConfiguration::m_radius, &CylinderShapeConfiguration::m_radius);
                }
            }
        }
