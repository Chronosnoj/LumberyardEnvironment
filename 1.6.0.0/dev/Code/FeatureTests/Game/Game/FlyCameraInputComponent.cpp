...
namespace
{
        ...
        int textureId)
    {
        ...
        draw2d->BeginDraw2d(true);
        {
            ...
            const Vec2 largeCirclePosition(initialPosition.x - largeCircleRadius, initialPosition.y - largeCircleRadius);
            const Vec2 largeCircleSize(largeCircleDiameter, largeCircleDiameter);
            ...
            const Vec2 smallCirclePosition(initialPosition.x + delta.x - smallCircleRadius,
                initialPosition.y + delta.y - smallCircleRadius);
            const Vec2 smallCircleSize(smallCircleDiameter, smallCircleDiameter);
