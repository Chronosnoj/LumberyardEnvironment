...
{
    static char gameBuffer[sizeof(LYGame::FeatureTestsGame)];

    ISystem* system = m_Framework->GetISystem();
    ModuleInitISystem(system, "FeatureTests");

    m_Game = new(reinterpret_cast<void*>(gameBuffer)) LYGame::FeatureTestsGame();
