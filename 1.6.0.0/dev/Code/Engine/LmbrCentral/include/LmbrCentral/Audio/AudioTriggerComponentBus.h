...
namespace LmbrCentral
{
    ...
    public:
        ...
        //! Execute and Kill functions where you can specify the ATL Trigger name manually.
    ...
    using AudioTriggerComponentRequestsBus = AZ::EBus<AudioTriggerComponentRequests>;
    ...
    using AudioTriggerComponentNotificationsBus = AZ::EBus<AudioTriggerComponentNotifications>;
