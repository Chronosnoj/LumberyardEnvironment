...
namespace LmbrCentral
{
    AZ_SCRIPTABLE_EBUS(
        ...
        CapsuleShapeComponentRequestsBus,
        "{ABDEC596-C828-44F7-883E-E9B92BA56E7A}",
        "{5BC46870-8A91-4531-BF40-0402226931AA}",
        AZ_SCRIPTABLE_EBUS_EVENT_RESULT(CapsuleShapeConfiguration, CapsuleShapeConfiguration(), GetCapsuleConfiguration)
    ...
    void CapsuleShapeComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (script)
        {
            ScriptableEBus_CapsuleShapeComponentRequestsBus::Reflect(script);
        }
    }
