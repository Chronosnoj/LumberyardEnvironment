...
void FileServer::EnsureCacheFolderExists(int connId)
{
    ...
    while (attemptNumber < maxAttempts)
    {
        ...
        HANDLE lockHandle = CreateFile(winFriendly.data(), GENERIC_READ | GENERIC_WRITE, 0, nullptr, CREATE_ALWAYS, 0, 0);
...
{
    size_t bytesSent;
    EBUS_EVENT_ID_RESULT(bytesSent, connId, AssetProcessor::ConnectionBus, Send, serial, response);
...
#include <native/FileServer/fileServer.moc>