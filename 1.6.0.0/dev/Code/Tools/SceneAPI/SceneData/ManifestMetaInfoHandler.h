    ...
    namespace SceneAPI
    {
        namespace SceneData
        {
            ...
            public:
                ...
                void GetCategoryAssignments(CategoryMap& categories) override;
                void GetAvailableModifiers(ModifiersList& modifiers, const AZStd::shared_ptr<const Containers::Scene>& scene, 
                    const DataTypes::IManifestObject* target) override;
