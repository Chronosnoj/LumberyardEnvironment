...
namespace
{
    ...
    public:
        ...
        virtual void RequestReady(NetworkRequestID networkRequestId, AzFramework::AssetSystem::BaseAssetProcessorMessage* message, QString platform, bool fencingFailed = false)
        {
            AssetRequestHandler::RequestReady(networkRequestId, message, platform, fencingFailed);
            m_requestReadyCount++;
            m_fencingFailed = fencingFailed;
        }
