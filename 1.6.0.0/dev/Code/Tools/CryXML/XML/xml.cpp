...
{
    char str[128];
    sprintf_s(str, "%g,%g,%g", value.x, value.y, value.z);
    setAttr(key, str);
}
...
{
    char str[128];
    sprintf_s(str, "%g,%g", value.x, value.y);
    setAttr(key, str);
}
...
{
    char str[128];
    sprintf_s(str, "%.17g,%.17g", value.x, value.y);
    setAttr(key, str);
}
...
{
    char str[128];
    sprintf_s(str, "%.17g,%.17g,%.17g", value.x, value.y, value.z);
    setAttr(key, str);
}
...
{
    char str[128];
    sprintf_s(str, "%g,%g,%g,%g", value.x, value.y, value.z, value.w);
    setAttr(key, str);
}
...
{
    char str[128];
    sprintf_s(str, "%g,%g,%g,%g", value.w, value.v.x, value.v.y, value.v.z);
    setAttr(key, str);
}
...
{
#if defined(WIN32) && !defined(CRYTOOLS)
