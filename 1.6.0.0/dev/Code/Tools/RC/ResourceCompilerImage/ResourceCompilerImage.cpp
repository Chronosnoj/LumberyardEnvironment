...
ICrySourceControl* g_pCrySourceControl;
ICrySourceControl* CrySourceControl(){ return g_pCrySourceControl; }
...
{
    g_pCrySourceControl = pRC->GetCrySourceControl();
