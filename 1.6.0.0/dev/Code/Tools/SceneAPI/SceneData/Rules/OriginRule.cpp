    ...
    namespace SceneAPI
    {
        namespace SceneData
        {
            ...
            void OriginRule::Reflect(ReflectContext* context)
            {
                ...
                if (!serializeContext || serializeContext->FindClassData(OriginRule::TYPEINFO_Uuid()))
                {
                    return;
                }
                ...
                if (editContext)
                {
                    editContext->Class<OriginRule>("Origin", "Changes the origin of the group.")
                        ...
                        ->DataElement(Edit::UIHandlers::Default, &OriginRule::m_rotation, "Rotation", "Rotates the group after translation.")
                            ...
                            ->Attribute(Edit::Attributes::StyleForX, "font: bold;")
                            ->Attribute(Edit::Attributes::StyleForY, "font: bold;")
                            ->Attribute(Edit::Attributes::StyleForZ, "font: bold;")
