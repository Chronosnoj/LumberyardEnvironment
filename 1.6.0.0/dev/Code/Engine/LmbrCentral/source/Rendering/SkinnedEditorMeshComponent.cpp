...
#include "SkinnedEditorMeshComponent.h"
...
namespace LmbrCentral
{
    ...
    void SkinnedEditorMeshComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
            ...
            serializeContext->Class<SkinnedEditorMeshComponent, EditorComponentBase>()
                ->Version(1)
                ->Field("Skinned Mesh Render Node", &SkinnedEditorMeshComponent::m_mesh)
                ;
            ...
            if (editContext)
            {
                editContext->Class<SkinnedEditorMeshComponent>("Skinned Mesh", "Attach skinned geometry to the entity.")
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &SkinnedEditorMeshComponent::m_mesh);
                ...
                editContext->Class<SkinnedMeshComponentRenderNode::SkinnedRenderOptions>(
                    ...
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_maxViewDist, "Max view distance", "Maximum view distance in meters.")
                        ->Attribute(AZ::Edit::Attributes::Suffix, " m")
                        ->Attribute(AZ::Edit::Attributes::Min, 0.f)
                        ->Attribute(AZ::Edit::Attributes::Max, &SkinnedMeshComponentRenderNode::GetDefaultMaxViewDist)
                        ->Attribute(AZ::Edit::Attributes::Step, 0.1f)
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_viewDistMultiplier, "View distance multiplier", "Adjusts max view distance. If 1.0 then default is used. 1.1 would be 10% further than default.")
                    ...
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_castShadows, "Cast dynamic shadows", "Casts dynamic shadows (shadow maps).")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_castLightmap, "Cast static shadows", "Casts static shadows (lightmap).")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_indoorOnly, "Indoor only", "Only render in indoor areas.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)

                    ->ClassElement(AZ::Edit::ClassElements::Group, "Advanced")

                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_allowBloom, "Enable bloom", "Enable bloom post effect.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_allowMotionBlur, "Enable motion blur", "Enable motion blur post effect.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_rainOccluder, "Rain occluder", "Occludes dynamic raindrops.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_affectDynamicWater, "Affect dynamic water", "Will generate ripples in dynamic water.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_receiveWind, "Receive wind", "Receives wind.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_acceptDecals, "Accept decals", "Can receive decals.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_affectNavmesh, "Affect navmesh", "Will affect navmesh generation.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_visibilityOccluder, "Visibility occluder", "Is appropriate for occluding visibility of other objects.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::m_depthTest, "Depth test", "Require depth testing.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::SkinnedRenderOptions::OnChanged)
                    ;

                editContext->Class<SkinnedMeshComponentRenderNode>(
                    "Mesh Rendering", "Attach geometry to the entity.")
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::m_visible, "Visible", "Is currently visible.")
                    ...
                    ->DataElement("SimpleAssetRef", &SkinnedMeshComponentRenderNode::m_material, "Material override", "Optionally specify an override material.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::OnAssetPropertyChanged)
                    ->DataElement(0, &SkinnedMeshComponentRenderNode::m_renderOptions, "Render options", "Render/draw options.")
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &SkinnedMeshComponentRenderNode::RefreshRenderState)
                    ;
            }
        }
    ...
    void SkinnedEditorMeshComponent::Activate()
    {
    ...
    void SkinnedEditorMeshComponent::Deactivate()
    {
    ...
    void SkinnedEditorMeshComponent::OnMeshCreated(const AZ::Data::Asset<AZ::Data::AssetData>& asset)
    {
        (void)asset;
    ...
    void SkinnedEditorMeshComponent::OnMeshDestroyed()
    {
        DestroyEditorPhysics();
    }

    IRenderNode* SkinnedEditorMeshComponent::GetRenderNode()
    {
        return &m_mesh;
    }

    float SkinnedEditorMeshComponent::GetRenderNodeRequestBusOrder() const
    {
        return s_renderNodeRequestBusOrder;
    }

    void SkinnedEditorMeshComponent::OnTransformChanged(const AZ::Transform& /*local*/, const AZ::Transform& world)
    {
        if (m_physicalEntity)
        {
    ...
    AZ::Aabb SkinnedEditorMeshComponent::GetWorldBounds()
    {
        return m_mesh.CalculateWorldAABB();
    }

    AZ::Aabb SkinnedEditorMeshComponent::GetLocalBounds()
    {
        return m_mesh.CalculateLocalAABB();
    }

    void SkinnedEditorMeshComponent::SetMeshAsset(const AZ::Data::AssetId& id)
    {
        m_mesh.SetMeshAsset(id);
        EBUS_EVENT(AzToolsFramework::ToolsApplicationRequests::Bus, AddDirtyEntity, GetEntityId());
    }

    void SkinnedEditorMeshComponent::SetMaterial(IMaterial* material)
    {
    ...
    IMaterial* SkinnedEditorMeshComponent::GetMaterial()
    {
        return m_mesh.GetMaterial();
    }

    void SkinnedEditorMeshComponent::SetPrimaryAsset(const AZ::Data::AssetId& id)
    {
        SetMeshAsset(id);
    }

    void SkinnedEditorMeshComponent::DisplayEntity(bool& handled)
    {
        if (m_mesh.HasMesh())
        {
    ...
    void SkinnedEditorMeshComponent::OnSelected()
    {
        m_mesh.SetAuxiliaryRenderFlags(ERF_SELECTED);
    }

    void SkinnedEditorMeshComponent::OnDeselected()
    {
        m_mesh.SetAuxiliaryRenderFlags(m_mesh.GetAuxiliaryRenderFlags() & ~ERF_SELECTED);
    }

    void SkinnedEditorMeshComponent::BuildGameEntity(AZ::Entity* gameEntity)
    {
    ...
    void SkinnedEditorMeshComponent::CreateEditorPhysics()
    {
        DestroyEditorPhysics();
    ...
    void SkinnedEditorMeshComponent::DestroyEditorPhysics()
    {
    ...
    ICharacterInstance* SkinnedEditorMeshComponent::GetCharacterInstance()
    {
