...
namespace AZ
{
    namespace RC
    {
        ...
        class ChrSkeletonGroupExporter
            : public SceneAPI::Events::CallProcessorBinder
        {
        public:
            explicit ChrSkeletonGroupExporter(IAssetWriter* writer, IConvertContext* convertContext);
            ~ChrSkeletonGroupExporter() override = default;

            SceneAPI::Events::ProcessingResult ProcessContext(ChrSkeletonGroupExportContext& context) const;
