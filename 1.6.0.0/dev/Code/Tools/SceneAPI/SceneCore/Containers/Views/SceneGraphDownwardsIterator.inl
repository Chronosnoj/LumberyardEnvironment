    ...
    namespace SceneAPI
    {
        namespace Containers
        {
            namespace Views
            {
                ...
                template<typename Iterator, typename Traversal>
                auto SceneGraphDownwardsIterator<Iterator, Traversal>::operator*()->reference
                {
                    return *m_iterator;
                }

                template<typename Iterator, typename Traversal>
                auto SceneGraphDownwardsIterator<Iterator, Traversal>::GetPointer(AZStd::true_type)->pointer
                {
                    return m_iterator;
                }

                template<typename Iterator, typename Traversal>
                auto SceneGraphDownwardsIterator<Iterator, Traversal>::GetPointer(AZStd::false_type)->pointer
                {
                    return m_iterator.operator->();
                }

                template<typename Iterator, typename Traversal>
                auto SceneGraphDownwardsIterator<Iterator, Traversal>::operator->()->pointer
                {
