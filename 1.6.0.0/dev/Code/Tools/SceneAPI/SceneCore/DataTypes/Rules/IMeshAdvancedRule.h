    ...
    namespace SceneAPI
    {
        namespace DataTypes
        {
            ...
            public:
                ...
                virtual const AZStd::string& GetUVStreamName() const = 0;
                // Returns whether or not the uv stream was explicitly disabled by the user. This does
                //      guarantee a valid uv stream name if false.
                virtual bool IsUVStreamDisabled() const = 0;
            };
        }  // DataTypes
    }  // SceneAPI
}  // AZ
