    ...
    namespace SceneAPI
    {
        namespace SceneData
        {
            ...
            void PhysicsRule::Reflect(ReflectContext* context)
            {
                ...
                if (!serializeContext || serializeContext->FindClassData(PhysicsRule::TYPEINFO_Uuid()))
                {
                    return;
                }
                ...
                if (editContext)
                {
                    editContext->Class<PhysicsRule>("Physics Proxy", "Collision data")
                        ->ClassElement(Edit::ClassElements::EditorData, "")
                            ->Attribute("AutoExpand", true)
                            ->Attribute(AZ::Edit::Attributes::NameLabelOverride, "")
                        ->DataElement(Edit::UIHandlers::Default, &PhysicsRule::m_nodeSelectionList, "Physics Meshes", "Collision meshes")
