...
################################################################
@conf
def load_debug_darwin_x64_android_armv7_gcc_settings(conf):
    """
    Setup all compiler and linker settings shared over all darwin_x64_android_armv7_gcc configurations for
    the 'debug' configuration
    """

    # load this first because it finds the compiler
    if not conf.load_darwin_x64_android_armv7_gcc_common_settings():
...
################################################################
@conf
def load_profile_darwin_x64_android_armv7_gcc_settings(conf):
    """
    Setup all compiler and linker settings shared over all darwin_x64_android_armv7_gcc configurations for
...
################################################################
@conf
def load_performance_darwin_x64_android_armv7_gcc_settings(conf):
    """
    Setup all compiler and linker settings shared over all darwin_x64_android_armv7_gcc configurations for
...
################################################################
@conf
def load_release_darwin_x64_android_armv7_gcc_settings(conf):
    """
    Setup all compiler and linker settings shared over all darwin_x64_android_armv7_gcc configurations for
