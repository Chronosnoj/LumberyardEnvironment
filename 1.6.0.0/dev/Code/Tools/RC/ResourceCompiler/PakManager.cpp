        ...
        do
        {
            ...
            // submit files for packing
            {
                ...
                if (bSplitOnSizeOverflow)
                {
                    ...
                    _snprintf_s(cPart, sizeof(cPart), _TRUNCATE, "-part%d.pak", currentPakPart + 0);
                    _snprintf_s(nPart, sizeof(nPart), _TRUNCATE, "-part%d.pak", currentPakPart + 1);
            ...
            else if (bSplitOnSizeOverflow && bMultiPartPak)
            {
                ...
                for (;; )
                {
                    ...
                    _snprintf_s(cPart, sizeof(cPart), _TRUNCATE, "-part%d.pak", trailingPakPart + 0);
                    _snprintf_s(nPart, sizeof(nPart), _TRUNCATE, "-part%d.pak", trailingPakPart + 1);
                    ...
                    if (fileSize <= nMinZipSize)
                    {
                        ...
                        for (int q = trailingPakPart;; q++)
                        {
                            ...
                            _snprintf_s(cPart, sizeof(cPart), _TRUNCATE, "-part%d.pak", q + 0);
                            _snprintf_s(nPart, sizeof(nPart), _TRUNCATE, "-part%d.pak", q + 1);
