...
def load_win_x64_win_x64_vs2010_common_settings(conf):
    ...
    try:
        ...
        if 'win_x64_vs2010' in conf.get_supported_platforms():
            Logs.warn('Unable to find Visual Studio 2010, removing build target')
...
@conf
def load_debug_win_x64_win_x64_vs2010_settings(conf):
    """
    Setup all compiler and linker settings shared over all win_x64_win_x64_vs2010 configurations for
    the 'debug' configuration
    """
    env = conf.env
    conf.load_win_x64_win_x64_vs2010_common_settings()
...
@conf
def load_profile_win_x64_win_x64_vs2010_settings(conf):
    """
    Setup all compiler and linker settings shared over all win_x64_win_x64_vs2010 configurations for
...
@conf
def load_performance_win_x64_win_x64_vs2010_settings(conf):
    """
    Setup all compiler and linker settings shared over all win_x64_win_x64_vs2010 configurations for
...
@conf
def load_release_win_x64_win_x64_vs2010_settings(conf):
    """
    Setup all compiler and linker settings shared over all win_x64_win_x64_vs2010 configurations for
