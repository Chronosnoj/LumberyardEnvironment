...
namespace LmbrCentral
{
    ...
    public:
        ...
        */
        SimpleAnimationComponentRequests::Result SetPlaybackSpeed(const AnimatedLayer::LayerId animatedLayerId, float playbackSpeed);
    ...
    public:
        ...
        AZ_COMPONENT(SimpleAnimationComponent, "{FBB470EF-2288-4B62-B41F-D830DD4C5B98}");
