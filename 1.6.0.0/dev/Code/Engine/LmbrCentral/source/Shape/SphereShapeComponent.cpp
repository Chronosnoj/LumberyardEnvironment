...
namespace LmbrCentral
{
    AZ_SCRIPTABLE_EBUS(
        ...
        SphereShapeComponentRequestsBus,
        "{21DA25C4-0EA2-4EB6-A97F-21881BB34F51}",
        "{616E78C3-BEFB-483B-99B9-6BFE197A4998}",
        AZ_SCRIPTABLE_EBUS_EVENT_RESULT(SphereShapeConfiguration, SphereShapeConfiguration(), GetSphereConfiguration)
    ...
    void SphereShapeComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (script)
        {
            ScriptableEBus_SphereShapeComponentRequestsBus::Reflect(script);
        }
    }
