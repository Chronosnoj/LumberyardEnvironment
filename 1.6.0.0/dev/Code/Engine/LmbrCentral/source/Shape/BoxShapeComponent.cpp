...
namespace LmbrCentral
{
    AZ_SCRIPTABLE_EBUS(
        ...
        BoxShapeComponentRequestsBus,
        "{A4CB1432-D72A-4064-BEF1-16E7B28A2A81}",
        "{A138A07F-5DC6-40AF-AF8A-679342C0C583}",
        AZ_SCRIPTABLE_EBUS_EVENT_RESULT(BoxShapeConfiguration, BoxShapeConfiguration(), GetBoxConfiguration)
        AZ_SCRIPTABLE_EBUS_EVENT(SetBoxDimensions,AZ::Vector3)
        )
    ...
    void BoxShapeComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (script)
        {
            ScriptableEBus_BoxShapeComponentRequestsBus::Reflect(script);
        }
    }
