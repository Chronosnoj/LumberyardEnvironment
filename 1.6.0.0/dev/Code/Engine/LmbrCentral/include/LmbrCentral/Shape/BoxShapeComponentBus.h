    ...
    public:
        ...
        static void Reflect(AZ::ReflectContext* context)
        {
            ...
            if (serializeContext)
            {
                ...
                if (scriptContext)
                {
                    scriptContext->Class<BoxShapeConfiguration, void(AZ::Vector3&), AZ::ScriptContext::SP_RAW_SCRIPT_OWN>("BoxShapeConfiguration")
                        ->Property("dimensions", &BoxShapeConfiguration::m_dimensions, &BoxShapeConfiguration::m_dimensions);
                }
            }
        }
