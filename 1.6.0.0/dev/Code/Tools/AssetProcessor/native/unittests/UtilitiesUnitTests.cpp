...
void UtilitiesUnitTests::StartTest()
{
    ...
    dummyList.push_back("c:/xyf/test1.log");
    dummyList.push_back("c:/xyf/test1.txt");
    dummyList.push_back("c:/xyf/test1.dds");

    UNIT_TEST_EXPECT_TRUE(CheckProductsExtension(dummyList, "dds"));
    UNIT_TEST_EXPECT_FALSE(CheckProductsExtension(dummyList, "xxx"));
