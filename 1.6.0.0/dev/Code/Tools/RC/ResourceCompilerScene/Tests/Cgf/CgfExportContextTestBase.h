    ...
    namespace RC
    {
        ...
        public:
            CgfExporterContextTestBase()
                ...
                , m_stubMeshGroupExportContext(m_stubScene, m_sampleOutputDirectory, m_sampleGroupName, m_stubMeshGroup, GetParam().second)
                , m_stubContainerExportContext(m_stubMeshGroupExportContext, m_outContent, GetParam().second)
                , m_stubNodeExportContext(m_stubContainerExportContext, m_outNode, m_sampleNodeName, m_sampleNodeIndex, m_samplePhysGeomType, GetParam().second)
        ...
        protected:
            ...
            CgfMeshGroupExportContext m_stubMeshGroupExportContext;
            CgfContainerExportContext m_stubContainerExportContext;
            CgfNodeExportContext m_stubNodeExportContext;
            CgfMeshNodeExportContext m_stubMeshNodeExportContext;
        };
    }
}