...
namespace AssetProcessor
{
    ...
    struct AssetRecognizer
    {
        ...
        AssetRecognizer(const QString& name, bool testLockSource, int priority, AssetUtilities::FilePatternMatcher patternMatcher, const QString& version)
            : m_name(name)
    ...
    public:
        ...
        void ReadRecognizersFromConfigFile(QString fileSource);
