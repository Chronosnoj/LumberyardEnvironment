...
#ifndef CRYINCLUDE_TOOLS_RC_RESOURCECOMPILER_IRESCOMPILER_H
#define CRYINCLUDE_TOOLS_RC_RESOURCECOMPILER_IRESCOMPILER_H
#pragma once
...
// This function is implemented by dlls that wish to perform unit tests
extern "C"
{
typedef void(__stdcall * FnRunUnitTests)(IUnitTestHelper*);
}
...
struct PlatformInfo
{
    ...
    bool HasName(const char* const pName) const
    {
        ...
        {
            if (_stricmp(pName, &platformNames[i][0]) == 0)
            {
                return true;
            }
        }
...
struct IResourceCompiler
{
    ...
    virtual void AddUnitTest(FnRunUnitTests unitTestFunction) = 0;
    ...
    //get the source control interface
    virtual ICrySourceControl* GetCrySourceControl() = 0;
...
#endif // CRYINCLUDE_TOOLS_RC_RESOURCECOMPILER_IRESCOMPILER_H
