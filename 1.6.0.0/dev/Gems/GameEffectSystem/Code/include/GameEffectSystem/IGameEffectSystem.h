...
// Creating a static version of SRegisterDataCallbacks inside an effect cpp registers the
// effect's data callback functions with the game effects system
struct SRegisterDataCallbacks
{
    SRegisterDataCallbacks(DataLoadCallback dataLoadingCallback,
        DataReleaseCallback dataReleaseCallback,
        DataReloadCallback dataReloadCallback)
    {
        IGameEffectSystem::RegisterDataLoadCallback(dataLoadingCallback);
        IGameEffectSystem::RegisterDataReleaseCallback(dataReleaseCallback);
        IGameEffectSystem::RegisterDataReloadCallback(dataReloadCallback);
    }
};
