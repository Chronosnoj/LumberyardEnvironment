...
void AssetScannerUnitTest::StartTest()
{
    ...
    // but we're going to not watch subfolder3 recursively, so... remove these files:
    ...
    config.AddScanFolder(ScanFolderInfo(tempPath.absolutePath(), "", true, false));
    config.AddScanFolder(ScanFolderInfo(tempPath.filePath("subfolder1"), "", false, true));
    config.AddScanFolder(ScanFolderInfo(tempPath.filePath("subfolder2"), "", false, true));
    config.AddScanFolder(ScanFolderInfo(tempPath.filePath("subfolder3"), "", false, false));
