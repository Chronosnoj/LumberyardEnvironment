    ...
    namespace SceneAPI
    {
        namespace Containers
        {
            namespace Views
            {
                ...
                //
                template<typename Iterator>
                FilterIterator<Iterator, AZStd::input_iterator_tag>::FilterIterator(Iterator iterator, Iterator end, const Predicate& predicate)
                ...
                template<typename Iterator>
                bool FilterIterator<Iterator, AZStd::input_iterator_tag>::operator==(const RootIterator& rhs) const
                {
                ...
                template<typename Iterator>
                auto FilterIterator<Iterator, AZStd::input_iterator_tag>::operator*()->reference
                {
                ...
                template<typename Iterator>
                auto FilterIterator<Iterator, AZStd::input_iterator_tag>::GetPointer(AZStd::true_type)->pointer
                {
                    return m_iterator;
                }
                ...
                template<typename Iterator>
                auto FilterIterator<Iterator, AZStd::input_iterator_tag>::GetPointer(AZStd::false_type)->pointer
                {
                    return m_iterator.operator->();
                }

                template<typename Iterator>
                auto FilterIterator<Iterator, AZStd::input_iterator_tag>::operator->()->pointer
                {
                    return GetPointer(AZStd::is_pointer<Iterator>::type());
                }
                ...
                //
                template<typename Iterator>
                FilterIterator<Iterator, AZStd::forward_iterator_tag>::FilterIterator(Iterator iterator, Iterator end, const Predicate& predicate)
                    : super(iterator, end, predicate)
                {
                }
                ...
                //
                template<typename Iterator>
                FilterIterator<Iterator, AZStd::bidirectional_iterator_tag>::FilterIterator(Iterator iterator, Iterator end, const Predicate& predicate)
                    : super(iterator, end, predicate)
                {
                ...
                template<typename Iterator>
                FilterIterator<Iterator, AZStd::bidirectional_iterator_tag>::FilterIterator(Iterator iterator, Iterator begin, Iterator end, const Predicate& predicate)
                    : super(iterator, end, predicate)
                    , m_begin(begin)
                {
                    while (m_begin != m_end && !m_predicate(*m_begin))
                    {
                ...
                template<typename Iterator>
                auto FilterIterator<Iterator, AZStd::bidirectional_iterator_tag>::operator--()->RootIterator &
                {
                    MoveToPrevious();
                    return *static_cast<RootIterator*>(this);
                }
                ...
                template<typename Iterator>
                auto FilterIterator<Iterator, AZStd::bidirectional_iterator_tag>::operator--(int)->RootIterator
                {
                    RootIterator result = *static_cast<RootIterator*>(this);
                    MoveToPrevious();
                    return result;
                ...
                {
                    if (m_iterator != m_begin)
                    {
                        AZStd::advance(m_iterator, -1);
                    }

                    while (m_iterator != m_begin && !m_predicate(*m_iterator))
                    {
                        AZStd::advance(m_iterator, -1);
                    }
                }
                ...
                //
                template<typename Iterator>
                FilterIterator<Iterator, AZStd::random_access_iterator_tag>::FilterIterator(Iterator iterator, Iterator end, const Predicate& predicate)
                    : super(iterator, end, predicate)
                {
                }

                template<typename Iterator>
                FilterIterator<Iterator, AZStd::random_access_iterator_tag>::FilterIterator(Iterator iterator, Iterator begin, Iterator end, const Predicate& predicate)
                ...
                //
                template<typename Iterator>
                FilterIterator<Iterator, AZStd::continuous_random_access_iterator_tag>::FilterIterator(
                    Iterator iterator, Iterator end, const Predicate& predicate)
                    : super(iterator, end, predicate)
                {
                }
                ...
                template<typename Iterator>
                FilterIterator<Iterator, AZStd::continuous_random_access_iterator_tag>::FilterIterator(
                    Iterator iterator, Iterator begin, Iterator end, const Predicate& predicate)
                    : super(iterator, begin, end, predicate)
                {
                }
                ...
                View<FilterIterator<Iterator> > MakeFilterView(Iterator current, Iterator end, const typename FilterIterator<Iterator>::Predicate& predicate)
                {
                    return Internal::MakeFilterView(current, end, predicate,
                        AZStd::is_base_of<AZStd::bidirectional_iterator_tag, typename AZStd::iterator_traits<Iterator>::iterator_category>::type());
                }
