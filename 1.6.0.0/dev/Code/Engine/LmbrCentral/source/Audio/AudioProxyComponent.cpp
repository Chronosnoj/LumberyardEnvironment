...
namespace LmbrCentral
{
    ...
    void AudioProxyComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
            ...
            if (editContext)
            {
                editContext->Class<AudioProxyComponent>("Audio Proxy", "Let the entity interact with audio. This can be removed after all other Audio components are removed.")
    ...
    void AudioProxyComponent::Activate()
    {
        ...
        EBUS_EVENT_ID_RESULT(m_transform, GetEntityId(), AZ::TransformBus, GetWorldTM);

        AudioProxyComponentRequestsBus::Handler::BusConnect(GetEntityId());
    ...
    {
        AudioProxyComponentRequestsBus::Handler::BusDisconnect(GetEntityId());
    ...
    //=========================================================================
    void AudioProxyComponent::SetEnvironmentAmount(const Audio::TAudioControlID environmentID, float amount)
    {
